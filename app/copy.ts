...
export const navOrder: SectionId[] = ['propuesta', 'services', 'solutions', 'technologies', 'clients', 'blog', 'contact'];
...
export const technologyLogos = [
  ...
  { name: 'Copilot', short: 'CPLT' },
  { name: 'Power BI', short: 'PBI' },
  { name: 'Power Automate', short: 'PA' },
  { name: 'Power Apps', short: 'PApps' },
  { name: 'Copilot Studio', short: 'C.Studio' },
  { name: 'Dataverse', short: 'DV' },
  { name: 'SharePoint', short: 'SP' },
  { name: 'Azure', short: 'AZ' },
  { name: 'GCP', short: 'GCP' },
  { name: 'AWS', short: 'AWS' },
  { name: 'Redshift', short: 'RS' },
  { name: 'SQL Server', short: 'SQL' }
];
...
const baseEs = {
  ...
  clients: [
    { title: 'Operaciones', description: 'Menos retrabajo y SLA cumplidos con flujos orquestados.', image: '/clients/client-1.svg' },
    { title: 'Ventas y marketing', description: 'Lead routing, scoring y alertas comerciales con datos confiables.', image: '/clients/client-2.svg' },
    { title: 'Finanzas', description: 'Control, conciliaciones y tableros trazables.', image: '/clients/client-3.svg' },
    { title: 'Personas', description: 'Onboarding, soporte interno y academias con IA segura.', image: '/clients/client-4.svg' }
  ],
  method: {
    title: 'Framework IMPULSUM',
    steps: 'Insight · Model · Pilot · Unify · Launch · Scale · Upskill · Measure',
    description: 'Descubrimos oportunidades, diseñamos soluciones, probamos impacto y medimos adopción con gobierno desde el inicio.'
  },
  blog: {
...
const baseEn: typeof baseEs = {
  ...
  clients: [
    { title: 'Operations', description: 'Less rework and SLA met through orchestrated flows.', image: '/clients/client-1.svg' },
    { title: 'Sales & marketing', description: 'Lead routing, scoring, and alerts powered by reliable data.', image: '/clients/client-2.svg' },
    { title: 'Finance', description: 'Control, reconciliations, and dashboards with traceability.', image: '/clients/client-3.svg' },
    { title: 'People', description: 'Onboarding, internal support, and academies with secure AI.', image: '/clients/client-4.svg' }
  ],
  method: {
    title: 'IMPULSUM Framework',
    steps: 'Insight · Model · Pilot · Unify · Launch · Scale · Upskill · Measure',
    description: 'We spot opportunities, design solutions, test impact, and measure adoption with governance from day one.'
  },
  blog: {
